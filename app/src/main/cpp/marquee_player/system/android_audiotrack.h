...
#ifndef MARQUEEPLAYER_ANDROID_AUDIOTRACK_H
#define MARQUEEPLAYER_ANDROID_AUDIOTRACK_H
...
namespace system {
    class SDL_Android_AudioTrack_Spec {
    public:
        enum StreamType {
            STREAM_VOICE_CALL = 0,
            STREAM_SYSTEM = 1,
    ...
    class SDL_Android_AudioTrack {
    public:
        jobject thiz;
        SDL_Android_AudioTrack_Spec spec;
    };
    SDL_Android_AudioTrack* SDL_Android_AudioTrack_new_from_sdl_spec(JNIEnv *env, SDL_AudioSpec *spec);
...
#endif //MARQUEEPLAYER_ANDROID_AUDIOTRACK_H
